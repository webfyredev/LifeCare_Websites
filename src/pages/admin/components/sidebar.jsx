...
import { LuLayoutDashboard, LuCalendarClock, LuFileHeart, LuPill, LuMessageSquare, LuUserCog, LuHeadphones, LuPhone, LuBell, LuChevronDown, LuChevronUp, LuUser, LuLogOut, LuFlaskConical, LuMenu, LuX, LuBookHeart, LuUsers, LuStethoscope, LuUserPlus, LuSearch } from 'react-icons/lu'
...
export default function Admin_Portal_sidebar(){
                ...
                <div className="w-[20%] h-screen bg-white border-r-1 border-slate-100 hidden lg:flex flex-col fixed left-0 top-0">
                    <div className="w-full h-15 border-b-1 border-slate-100 flex space-x-1 items-center px-2.5">
                        ...
                        <div className='w-auto flex flex-col space-y-0'>
                            ...
                            <p className='text-[11px] text-slate-400 font-semibold'>Admin Portal</p>
                        </div>
                    </div>
                    <div className='w-full h-full flex flex-col items-center justify-between py-3 mt-2'>
                        <div className='w-full px-2.5 flex flex-col space-y-2.5'>
                            <NavLink to="/admin/dashboard" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                <LuLayoutDashboard  className='mt-0.5'/>
                                <span>Dashboard</span>
                            </NavLink>
                            <NavLink to="/admin/users" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                <LuUsers  className='mt-0.5'/>
                                <span>Users</span>
                            </NavLink>
                            <NavLink to="/admin/doctors" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                <LuStethoscope  className='mt-0.5'/>
                                <span>Doctors</span>
                            </NavLink>
                            <NavLink to="/admin/appointments" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                <LuCalendarClock  className='mt-0.5'/>
                                <span>Appointments</span>
                            </NavLink>
                            <NavLink to="/admin/prescriptions" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                <LuPill  className='mt-0.5'/>
                                <span>Prescriptions</span>
                            </NavLink>
                            <NavLink to="/admin/records" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                <LuFileHeart  className='mt-0.5'/>
                                <span>Records</span>
                            </NavLink>
                            <NavLink to="/admin/messages" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center justify-between ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                            ...
                            <motion.div 
                                ...
                                <div className='w-full h-full flex flex-col items-center justify-between py-3 mt-2'>
                                    <div className='w-full px-2.5 flex flex-col space-y-2.5'>
                                        ...
                                        <NavLink to="/admin/messages" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                                            <LuMessageSquare  className='mt-0.5'/>
                                            <span>Messages</span>
                                        </NavLink>
                                        <NavLink to="/admin/notifications" className={({ isActive}) => `font-medium text-[13px] rounded-lg px-3 py-2.5 flex items-center space-x-3 ${isActive ? 'bg-blue-50 text-blue-600' : 'text-[#64748b] hover:text-[#334155] hover:bg-[#f8fafc]'}`}>
                ...
                <div className='w-full lg:w-[80%] lg:ml-[20%] flex flex-col h-screen'>
                    <div className='px-5 w-full lg:w-[80%] h-13 bg-white border-b-1 border-slate-100 flex justify-between items-center fixed top-0 right-0 w-[80%] z-10'>
                        ...
                        <div className='w-auto flex items-center space-x-5 lg:mr-5 relative' ref={notifRef}>
                            ...
                            <div onClick={() => setIsOpen(!isOpen)}  className='flex space-x-3 px-4 py-1 rounded-lg items-center hover:bg-[#f8fafc] cursor-pointer' ref={profileRef}>
                        ...
                        {isOpen && (
                            <motion.div 
                                ...
                                <Link to="/admin/settings" className="w-full mt-1.5 font-normal text-[13px] rounded-lg px-1.5 py-2 flex items-center space-x-3 text-[#475569] hover:bg-[#f8fafc]">
                                    <LuUser className='mt-0.5'/>
                                    <span>My Profile</span>
                                </Link>
                                <Link to="/admin/dashboard" className="w-full mt-1.5 font-normal text-[13px] rounded-lg px-1.5 py-2 flex items-center space-x-3 text-[#475569] hover:bg-[#f8fafc]">
                                    <LuLayoutDashboard  className='mt-0.5'/>
                                    <span>Dashboard</span>
                                </Link>
                                <Link to="/admin/notifications" className="w-full mt-1.5 font-normal text-[13px] rounded-lg px-1.5 py-2 flex md:hidden  items-center space-x-3 text-[#475569] hover:bg-[#f8fafc]">
                                    <LuBell  className='mt-0.5'/>
                                    <span>Notifications</span>
                                </Link>
