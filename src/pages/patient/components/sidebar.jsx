                    ...
                    <div className='px-5 w-full lg:w-[80%] h-13 bg-white border-b-1 border-slate-100 flex justify-between items-center fixed top-0 right-0 w-[80%] z-10'>
                        ...
                        {isOpen && (
                            <motion.div 
                                ...
                                <Link to="/patient/notifications" className="w-full mt-1.5 font-normal text-[13px] rounded-lg px-1.5 py-2 flex md:hidden  items-center space-x-3 text-[#475569] hover:bg-[#f8fafc]">
