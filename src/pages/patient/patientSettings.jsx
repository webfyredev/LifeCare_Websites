...
export default function PaitientSettings(){
    ...
    useEffect(() => {
        document.title = 'Profile Settings - Lifecare'
        if(user && !formInitialized) {
            ...
            setProfileForm({
                ...
                insurance_number: user.patient_profile?.insurance_number ?? '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await api.patch('/patients/profile/update/', profileForm)
                ...
                <form onSubmit={handleSubmit} className='flex flex-col space-y-5 mt-5 '>
                    <div className='w-full p-6 rounded-xl bg-white border-slate-100 transition-all duration-300 border flex space-x-5'>
                        ...
                        <div className='w-auto flex flex-col'>
                            <h3 className='text-xl font-semibold text-[#1e293b]'>{user?.first_name} {user?.last_name}</h3>
                    ...
                    <div className='w-full px-3 md:px-5 py-5 bg-white border-slate-100 rounded-xl flex flex-col'>
                        ...
                        <div className='w-full grid grid-cols-2 gap-4 py-2 mt-3'>
                            ...
                            <div className='flex flex-col space-y-2'>
                                <label className='text-xs font-semibold text-slate-500'>Insurance Number</label>
                                <input
                                    name='insurance_number'
                                    value={profileForm.insurance_number}
                                    onChange={handleProfileChange}
                                    placeholder='e.g. INS-001234'
                                    className='border border-slate-200 rounded-lg px-3 py-2.5 text-sm outline-blue-300'
                                />
                            </div>
                            <div className='flex flex-col space-y-2'>
                            ...
                            <div className='flex flex-col space-y-2'>
                                <label className='text-xs font-semibold text-slate-500'>Medical History</label>
                                <textarea
