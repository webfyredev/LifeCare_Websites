...
export default function Doctors(){
    return(
        <>
            <div className="w-full p-5 flex flex-col items-center bg-[#F9FAFB]">
                <h3 className="text-3xl font-bold mt-5">
                    Meet Our Doctors
                </h3>
                <div className="w-full mt-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 p-5">
                    {doctors.map((doctor) =>(
                        <div key={doctor.id}>
